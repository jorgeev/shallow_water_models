...
model = ShallowWaterModel.create(
    ...
    plotting=True, plot_path="sim_output", plot_interval=100, exp_name="debug_model"
)
...
# Channel model
model = ShallowWaterModel.create("channel", period=1500, X=200, Y=200, nt=3000, DT=0.1, exp_name="channel_model", save_interval=100, plotting=True)
model.run()
